...
const App = () => {
  ...
  return (
    <div className='h-screen lg:flex bg-black text-white'>
      <form onSubmit={(e)=>{
        submitHandler(e)
      }}className='flex gap-4 lg:w-1/2 p-10 flex-col item-start'>
        ...
        {/* DETAILED WALA INPUT */}
          <textarea 
            type="text"
            className='px-5 py-2 h-32 w-full 
            font-medium outline-none  border-2 rounded'
          ...
          <button className='bg-white active:scale-95 text-black w-full font-medium  px-5 py-2 outline-none  rounded'>Add Note</button>
